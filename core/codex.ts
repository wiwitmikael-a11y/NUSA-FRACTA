...
export const codex: Codex = {
  items: {
    ...
    'palu_godam': {
        ...
        type: 'weapon',
        equipmentSlot: 'meleeWeapon',
        effects: [{ type: 'SKILL_BONUS', key: 'flat_damage_bonus', value: 10 }],
        value: 120
    },
    ...
    'pelindung_bahu_rakitan': {
      name: 'Pelindung Bahu Rakitan',
      description: 'Dibuat dari rambu lalu lintas dan sabuk pengaman. Memberikan perlindungan yang lumayan.',
      type: 'armor',
      equipmentSlot: 'armor',
    ...
    'minuman_energi_rakitan': { 
        ...
        type: 'consumable', 
        effects: [{ type: 'SKILL_BONUS', key: 'healing_effectiveness', value: 30 }], 
        value: 45 
    },
  ...
  enemies: {
    ...
    'anjing_mutan_selokan': {
        name: 'Anjing Mutan Selokan',
        description: 'Anjing liar yang telah bermutasi karena limbah beracun di selokan. Kulitnya licin dan tatapannya ganas.',
        hp: 45,
        attack: 10,
        defense: 4,
        xpValue: 25,
        lootTable: [{ itemId: 'kain_bekas', chance: 0.6, quantity: [1, 3] }],
        skripDrop: [8, 18],
    },
    'anjing_mutan_bertanduk': {
        name: 'Anjing Mutan Bertanduk',
        description: 'Mutasi yang lebih ganas, dengan tanduk tulang menonjol dari tengkoraknya. Sangat teritorial dan agresif.',
        hp: 70,
        attack: 18,
        defense: 7,
        xpValue: 50,
        lootTable: [{ itemId: 'kain_bekas', chance: 0.4, quantity: [2, 4] }],
        skripDrop: [25, 50],
    },
    'preman_kumuh': {
        name: 'Preman Kumuh',
    ...
    'perampok_nekat': {
      name: 'Perampok Nekat',
      description: 'Lebih berpengalaman dan lebih putus asa dari perampok biasa. Mereka tidak akan ragu untuk bertarung sampai mati.',
      hp: 75,
      attack: 18,
      defense: 10,
      xpValue: 55,
      lootTable: [
          { itemId: 'kunci_inggris', chance: 0.4, quantity: [1, 1] },
          { itemId: 'stimulan', chance: 0.2, quantity: [1, 1] },
          { itemId: 'jaket_kulit_usang', chance: 0.2, quantity: [1, 1] },
      ],
      skripDrop: [30, 60],
    },
    'letnan_geng_bangsat': {
      name: 'Letnan Geng Bangsat',
      description: 'Seorang anggota Geng Bangsat yang telah membuktikan dirinya. Kejam, licik, dan lebih tangguh.',
      hp: 100,
      attack: 22,
      defense: 12,
      xpValue: 80,
      lootTable: [
          { itemId: 'golok', chance: 0.5, quantity: [1, 1] },
          { itemId: 'rompi_improvisasi', chance: 0.3, quantity: [1, 1] },
          { itemId: 'stimulan', chance: 0.5, quantity: [1, 1] },
      ],
      skripDrop: [50, 100],
    },
    'robot_penjaga_rusak': {
    ...
    'drone_pengintai': {
        ...
        description: 'Sebuah drone kecil dan gesit, mungkin sisa dari patroli Teknokrat. Sulit untuk dipukul.',
        hp: 25,
        attack: 9,
        defense: 12, // High defense represents its agility
        xpValue: 20,
        lootTable: [
            { itemId: 'komponen_elektronik', chance: 0.7, quantity: [1, 2] },
            { itemId: 'baterai_bekas', chance: 0.3, quantity: [1, 1] },
        ],
        skripDrop: [10, 20],
    },
    'drone_tempur_kumbang': {
        name: 'Drone Tempur "Kumbang"',
        description: 'Drone yang lebih besar dan berlapis baja, dimodifikasi oleh Gerombolan Besi untuk pertempuran. Lambat tapi mematikan.',
        hp: 90,
        attack: 20,
        defense: 18,
        xpValue: 85,
        lootTable: [
            { itemId: 'suku_cadang_mekanik', chance: 0.8, quantity: [2, 4] },
            { itemId: 'komponen_elektronik', chance: 0.5, quantity: [3, 6] },
        ],
        skripDrop: [60, 110],
    },
    'anomali_tengkorak': {
  ...
  recipes: {
    ...
    'pelindung_bahu_rakitan_recipe': {
        name: 'Pelindung Bahu Rakitan',
        result: { itemId: 'pelindung_bahu_rakitan', quantity: 1 },
        ingredients: [
            { itemId: 'plastik_bekas', quantity: 4 },
            { itemId: 'sekrup_baut', quantity: 6 },
            { itemId: 'kabel_tembaga', quantity: 2 },
        ],
    },
    'minuman_energi_rakitan_recipe': {
        name: 'Minuman Energi Rakitan',
        result: { itemId: 'minuman_energi_rakitan', quantity: 1 },
        ingredients: [
            { itemId: 'air_kemasan', quantity: 1 },
            { itemId: 'kopi_instan', quantity: 1 },
            { itemId: 'baterai_bekas', quantity: 1 },
        ],
    },
  },
  quests: {
